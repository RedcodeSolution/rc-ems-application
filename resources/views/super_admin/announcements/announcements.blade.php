                        ...
                        <tr class="announcement-row" data-id="{{ $announcement->id }}">
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn-action btn-view" onclick="viewAnnouncement({{ $announcement=>id ?? 0 }})" title="View">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <button class="btn-action btn-edit" onclick="editAnnouncement({{ $announcement=>id ?? 0 }})" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button class="btn-action btn-duplicate" onclick="duplicateAnnouncement({{ $announcement=>id ?? 0 }})" title="Duplicate">
                                        <i class="fas fa-copy"></i>
                                    </button>
                                    <button class="btn-action btn-delete" onclick="deleteAnnouncement({{ $announcement=>id ?? 0 }})" title="Delete">

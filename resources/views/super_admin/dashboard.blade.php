    ...
    <div class="stats-grid">
        <div class="stat-card admins">
            ...
            <div class="stat-content">
                <h3>Total Admins</h3>
                <div class="stat-number">{{ $dashboardStats['total_admins'] }}</div>
        ...
        <div class="stat-card employees">
            ...
            <div class="stat-content">
                ...
                <div class="stat-number">{{ $dashboardStats['total_employees'] }}</div>
                <p>Active workforce</p>
            </div>
            <div class="stat-trend positive">
                <i class="fas fa-arrow-up"></i> +{{ $dashboardStats['recent_registrations'] }}
            </div>
        </div>
        ...
        <div class="stat-card departments">
            ...
            <div class="stat-content">
                <h3>Departments</h3>
                <div class="stat-number">{{ $dashboardStats['total_departments'] }}</div>
        ...
        <div class="stat-card projects">
            ...
            <div class="stat-content">
                ...
                <div class="stat-number">{{ $dashboardStats['active_projects'] }}</div>
        ...
        <div class="stat-card leaves">
            ...
            <div class="stat-content">
                ...
                <div class="stat-number">{{ $dashboardStats['pending_leaves'] }}</div>
        ...
        <div class="stat-card alerts">
            ...
            <div class="stat-content">
                <h3>System Alerts</h3>
                <div class="stat-number">{{ $dashboardStats['system_alerts'] }}</div>
                <p>Active alerts</p>
            </div>
            <div class="stat-trend warning">
                ...
                <div class="card-content">
                    <div class="health-metrics">
                        ...
                        <div class="health-metric">
                            ...
                            <span class="metric-value">{{ $systemHealth['database_health'] }}</span>
                        </div>
                        <div class="health-metric">
                            <span class="metric-label">Storage Usage</span>
                            <span class="metric-value">{{ $systemHealth['storage_usage'] }}</span>
                        </div>
                        <div class="health-metric">
                            <span class="metric-label">Active Sessions</span>
                            <span class="metric-value">{{ $systemHealth['active_sessions'] }}</span>
                        </div>
                        <div class="health-metric">
                            <span class="metric-label">Avg Response Time</span>
                            <span class="metric-value">{{ $systemHealth['avg_response_time'] }}</span>
                        </div>
                        <div class="health-metric">
                            <span class="metric-label">Error Rate</span>
                            <span class="metric-value">{{ $systemHealth['error_rate'] }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-content">
                <div class="status-grid">
                    ...
                    <div class="status-item">
                        ...
                        <div class="status-content">
                            <h4>Storage</h4>
                            <p>{{ $systemHealth['storage_usage'] }} used - Consider cleanup</p>
...
<script>
    ...
    // Chart data
    const chartData = {
        registrations: {{ json_encode($chartData['monthly_registrations']) }},
        leaves: {{ json_encode($chartData['leave_requests']) }},
        projects: {{ json_encode($chartData['project_completion']) }}
    };

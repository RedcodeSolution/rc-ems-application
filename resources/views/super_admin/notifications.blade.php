    ...
    <div class="notifications-container">
        ...
        <div class="notification-stats-grid">
            ...
            <div class="notification-stat-card unread">
                ...
                <div class="stat-content">
                    <h3>Read</h3>
                    <div class="stat-number">{{ $notificationStats['read'] }}</div>
                </div>
    ...
    <script>
        ...
        function viewNotification(notificationId) {
            ...
            const notificationData = {
                ...
                typeDisplay: notificationElement.querySelector('.notification-type').textContent.replace('🏷️ ', '')
                    .trim(),
                ...
                color: notificationElement.querySelector('.notification-icon').className.split(' ')
                    .find(cls => cls !== 'notification-icon')
            };

            console.log(notificationData.status);

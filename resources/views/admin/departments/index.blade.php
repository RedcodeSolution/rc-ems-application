    ...
    <div class="card-body">
        ...
        <div id="departmentsGrid" class="departments-grid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="flex gap-1">
                        <button class="btn btn-warning edit-btn" title="Edit Department" onclick="openEditDepartmentModal('{{ $department->department_id }}')">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="btn btn-danger delete-btn" title="Delete Department" onclick="confirmDeleteDepartment('{{ $department->department_id }}', '{{ $department->department_name ?? $department->department_id }}')">
                ...
                <div class="card-body">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="#" class="btn btn-secondary view-details-btn" onclick="viewDepartmentDetails('{{ $department->department_id }}')">
            ...
            <div class="departments-empty">
                ...
                <p class="empty-desc">Start by creating your first department using the "Add Department" button above.</p>
            </div>
            @endforelse
        </div>
    </div>
            ...
            <form id="departmentForm" action="{{ route('admin.departments.store') }}" method="POST">
                ...
                <div class="form-container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <textarea id="description" name="description" class="form-input" placeholder="Describe the department's role and responsibilities" rows="3"></textarea>
                        </div>
                        <small class="form-hint">
            ...
            <form id="editDepartmentForm"  method="POST">
                ...
                <div class="form-container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <textarea id="edit_description" name="description" class="form-input" placeholder="Describe the department's role and responsibilities" rows="3"></textarea>
                        </div>
                        <small class="form-hint">
                            Brief description of the department's purpose
                        </small>
         ...
         <div class="mb-1 total-employees">
            ...
            if (department.description) {
                html += `
                    <div class="mb-1 department-description">
                        <div class="label">Description</div>
                        <div class="value">${department.description.length > 100 ? department.description.substring(0, 100) + '...' : department.description}</div>
                    </div>`;
            }
            ...
            html += `
                    <div class="flex justify-between items-center">
                        <span class="badge department-status" data-status="${department.status}" style="background: ${statusBg}; color: var(--${statusClass}); padding: 0.25rem 0.75rem; border-radius: 1rem; font-size: 0.75rem;">
                            ${department.status || 'Active'}
                        </span>
                        <a href="#" class="btn btn-secondary view-details-btn" onclick="viewDepartmentDetails('${department.department_id}')">
                            <i class="fas fa-eye"></i>

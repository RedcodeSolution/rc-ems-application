            ...
            <div class="employee-rating-card">
                <div class="employee-info-section">
                    ...
                    <div class="employee-actions">
                        <button class="btn btn-secondary btn-sm" onclick="viewEmployeeRatings({{ $employeeId }})">
                            <i class="fas fa-eye"></i> View Details
                        </button>
                        <button class="btn btn-primary btn-sm" onclick="rateEmployee({{ $employeeId }})">
...
<!-- View Employee Ratings Modal -->
<div id="viewEmployeeRatingsModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h2>Employee Rating Details</h2>
            <button class="modal-close" onclick="closeModal('viewEmployeeRatingsModal')">
                <i class="fas fa-times"></i>
            </button>
        </div>
        <div class="modal-body">
            <div id="employee-ratings-content">
                <!-- Employee ratings will be loaded here -->
            </div>
        </div>
        <div class="modal-footer">
            <button class="btn btn-secondary" onclick="closeModal('viewEmployeeRatingsModal')">
                Close
            </button>
        </div>
    </div>

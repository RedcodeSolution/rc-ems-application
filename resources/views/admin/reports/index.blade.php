...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
            ...
            <div class="card">
                <div class="card-body text-center">
                    <div style="font-size: 2rem; font-weight: 700; color: var(--success); margin-bottom: 0.5rem;">{{ $activeProjects ?? 47 }}</div>
                    <div style="color: var(--gray-600); font-weight: 500;">Active Projects</div>
                </div>
            </div>
            <div class="card">
                <div class="card-body text-center">
                    <div style="font-size: 2rem; font-weight: 700; color: var(--info); margin-bottom: 0.5rem;">{{ $employeeCount ?? 156 }}</div>
                    <div style="color: var(--gray-600); font-weight: 500;">Employees</div>
                </div>
            </div>
            <div class="card">
                <div class="card-body text-center">
                    <div style="font-size: 2rem; font-weight: 700; color: var(--warning); margin-bottom: 0.5rem;">{{ $efficiency ?? '94.2%' }}</div>
        ...
        <div class="flex justify-between items-center mb-4">
            <div class="flex gap-2">
                <input type="text" placeholder="Search reports..." class="form-input" style="width: 300px;">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span class="badge" style="background: rgba(59, 130, 246, 0.1); color: var(--primary);">Employee</span>
                        </td>
                        <td>Admin User</td>
                        <td>Nov 1, 2024</td>
                        <td>
                        ...
                        <td>
                            <div class="flex gap-1">
                                <button class="btn btn-secondary" style="padding: 0.5rem;" onclick="openViewReportModal('Monthly Attendance Report', 'RPT001', 'Admin User', 'Nov 1, 2024', 'Completed', 'Employee', 'October 2024', 'Monthly attendance summary for all employees', 'PDF', '2.4 MB', 'Comprehensive attendance tracking report including daily check-ins, check-outs, overtime hours, and leave records.')">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button class="btn btn-primary" style="padding: 0.5rem;" onclick="downloadReportById('RPT001', 'Monthly Attendance Report')">
                                    <i class="fas fa-download"></i>
                                </button>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge" style="background: rgba(99, 102, 241, 0.1); color: var(--secondary);">Department</span>
                        </td>
                        <td>HR Manager</td>
                        <td>Oct 28, 2024</td>
                        <td>
                        ...
                        <td>
                            <div class="flex gap-1">
                                <button class="btn btn-secondary" style="padding: 0.5rem;" onclick="openViewReportModal('Department Performance Analysis', 'RPT002', 'HR Manager', 'Oct 28, 2024', 'Completed', 'Department', 'Q3 2024', 'Performance analysis across all departments', 'Excel', '1.8 MB', 'Detailed performance metrics including productivity, efficiency, and goal achievement for all departments.')">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button class="btn btn-primary" style="padding: 0.5rem;" onclick="downloadReportById('RPT002', 'Department Performance Analysis')">
                                    <i class="fas fa-download"></i>
                                </button>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge" style="background: rgba(245, 158, 11, 0.1); color: var(--warning);">Project</span>
                        </td>
                        <td>Project Manager</td>
                        <td>Oct 25, 2024</td>
                        <td>
                            <span class="badge" style="background: rgba(245, 158, 11, 0.1); color: var(--warning);">Processing</span>
                        </td>
                        <td>
                            <div class="flex gap-1">
                                <button class="btn btn-secondary" style="padding: 0.5rem;" onclick="openViewReportModal('Project Timeline Report', 'RPT003', 'Project Manager', 'Oct 25, 2024', 'Processing', 'Project', 'All Active Projects', 'Timeline analysis for all active projects', 'PDF', '3.2 MB', 'Comprehensive project timeline report showing milestones, dependencies, and progress status for all active projects.')">
                                    <i class="fas fa-eye"></i>
                                </button>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-top: 2rem;">
    ...
    <div class="card">
        <div class="card-body text-center">
            <div style="font-size: 2rem; font-weight: 700; color: var(--success); margin-bottom: 0.5rem;">9</div>
    ...
    <div class="card">
        <div class="card-body text-center">
            ...
            <div style="color: var(--gray-600); font-weight: 500;">Processing</div>
        </div>
    </div>
    <div class="card">
        <div class="card-body text-center">
            <div style="font-size: 2rem; font-weight: 700; color: var(--danger); margin-bottom: 0.5rem;">1</div>
            <div style="color: var(--gray-600); font-weight: 500;">Failed</div>
        </div>
    </div>
</div>
                ...
                <div class="form-container">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="employee_filter" name="employee_filter" class="form-select">
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-top: 0.5rem;">
                            ...
                            <div class="form-checkbox">
                                <input type="checkbox" id="include_summary" name="include_summary" value="1" checked>
                                <label for="include_summary">Include Executive Summary</label>
                            </div>
                            <div class="form-checkbox">
                                <input type="checkbox" id="include_details" name="include_details" value="1" checked>
                                <label for="include_details">Include Detailed Data</label>
                            </div>
                            <div class="form-checkbox">
                                <input type="checkbox" id="auto_schedule" name="auto_schedule" value="1">
                                <label for="auto_schedule">Auto-Schedule Generation</label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="schedule_frequency" class="form-label">
                                    <i class="fas fa-clock"></i>Schedule Frequency
                                </label>
                                <select id="schedule_frequency" name="schedule_frequency" class="form-select">
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" id="schedule_time" name="schedule_time" class="form-input" value="09:00">
                            </div>
                        </div>
                    </div>
...
function downloadReportById(reportId, reportName) {
    // Show loading state
    ...
    const link = document.createElement('a');
    link.href = downloadUrl;
    link.download = `${reportName}.pdf`; // Default to PDF
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);

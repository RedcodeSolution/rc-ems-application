                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="employee_name" name="employee_name" 
                                   value="John Doe" class="form-control" readonly>
                        </div>

                        <div class="form-group">
                            <label for="email">Email Address</label>
                            <input type="email" id="email" name="email" 
                                   value="john.doe@redcodesolutions.com" class="form-control" readonly>
                        </div>

                        <div class="form-group">
                            <label for="contact_no">Contact Number</label>
                            <input type="text" id="contact_no" name="contact_no" 
                                   value="+1 (555) 123-4567" class="form-control" readonly>
                        </div>

                        <div class="form-group">
                            <label for="employee_id">Employee ID</label>
                            <input type="text" id="employee_id" 
                                   value="EMP001" class="form-control" readonly disabled>
                        </div>

                        <div class="form-group">
                            <label for="employee_type">Employee Type</label>
                            <input type="text" id="employee_type" 
                                   value="Full Time" class="form-control" readonly disabled>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="joining_date" 
                                   value="January 15, 2024" class="form-control" readonly disabled>
                        </div>

                        <div class="form-group">
                            <label for="date_of_birth">Date of Birth</label>
                            <input type="date" id="date_of_birth" name="date_of_birth" 
                                   value="1990-05-15" class="form-control" readonly>
                        </div>
                    </div>
                ...
                <div class="skills-section" id="skillsSection">
                    <div class="skill-category">
                        ...
                        <div class="skill-tags" data-category="programming">
                            ...
                            <button class="add-skill-btn" onclick="openAddSkillModal('programming')" style="display: none;">
                    ...
                    <div class="skill-category">
                        ...
                        <div class="skill-tags" data-category="frameworks">
                            ...
                            <button class="add-skill-btn" onclick="openAddSkillModal('frameworks')" style="display: none;">
                                <i class="fas fa-plus"></i>
                                Add Skill
                            </button>
                        </div>
        ...
        <div class="modal-body">
            <form id="addSkillForm">
                <div class="form-group">
                    ...
                    <input type="text" id="skillName" name="skill_name" class="form-control" placeholder="e.g., JavaScript, Laravel, Docker" required>
                </div>
                <div class="form-group">

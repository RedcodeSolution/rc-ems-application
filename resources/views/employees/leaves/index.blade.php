            ...
            <div class="stat-card annual-leave">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-progress">
                        ...
                        <span class="remaining">9 days remaining</span>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card sick-leave">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-progress">
                        ...
                        <span class="remaining">7 days remaining</span>
                    </div>
                </div>
            </div>
            ...
            <div class="stat-card personal-leave">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-progress">
                        ...
                        <span class="remaining">3 days remaining</span>
                    </div>
                </div>
            </div>
        ...
        <div class="requests-container">
            ...
            <div class="request-card pending">
                <div class="request-header">
                    <div class="request-info">
                        <h4>Annual Leave</h4>
                        <span class="request-date">March 15 - March 20, 2025</span>
                    </div>
                ...
                <div class="request-details">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="value">March 1, 2025</span>
                    </div>
                    <div class="detail-item">
                        <span class="label">Reason:</span>
                        <span class="value">Family vacation</span>
                    </div>
                </div>
                <div class="request-actions">
                    <button class="action-btn view" onclick="viewLeaveRequest('LEV-2025-001')" title="View Details">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="action-btn edit" onclick="editLeaveRequest('LEV-2025-001')" title="Edit Request">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="action-btn cancel" onclick="cancelLeaveRequest('LEV-2025-001')" title="Cancel Request">
            ...
            <div class="request-card approved">
                <div class="request-header">
                    <div class="request-info">
                        <h4>Sick Leave</h4>
                        <span class="request-date">February 10 - February 12, 2025</span>
                    </div>
                ...
                <div class="request-details">
                    ...
                    <div class="detail-item">
                        <span class="label">Reason:</span>
                        <span class="value">Medical treatment</span>
                    </div>
                </div>
                <div class="request-actions">
                    <button class="action-btn view" onclick="viewLeaveRequest('LEV-2025-002')" title="View Details">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="action-btn download" onclick="downloadCertificate('LEV-2025-002')" title="Download Certificate">
            ...
            <div class="request-card rejected">
                <div class="request-header">
                    <div class="request-info">
                        ...
                        <span class="request-date">January 25 - January 26, 2025</span>
                    </div>
                ...
                <div class="request-details">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="value">Mike Davis</span>
                    </div>
                    <div class="detail-item">
                        <span class="label">Reason:</span>
                        <span class="value">Project deadline conflict</span>
                    </div>
                </div>
                <div class="request-actions">
                    <button class="action-btn view" onclick="viewLeaveRequest('LEV-2025-003')" title="View Details">
                        <i class="fas fa-eye"></i>
                    </button>
                    <button class="action-btn reapply" onclick="reapplyLeave('LEV-2025-003')" title="Reapply Leave">
    ...
    <div id="viewLeaveModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="editFromViewBtn" class="btn btn-primary" onclick="editFromView()" style="display: none;">
                ...
                <div class="modal-body">
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editReason" name="reason" class="form-control" rows="4" placeholder="Please provide a detailed reason for your leave request..." required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="editContactInfo">Contact Information</label>
                            <input type="text" id="editContactInfo" name="contact_info" class="form-control" placeholder="Emergency contact number or email">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="reason" name="reason" class="form-control" rows="4" placeholder="Please provide a detailed reason for your leave request..." required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="contactNumber">Emergency Contact</label>
                            <input type="tel" id="contactNumber" name="contact_number" class="form-control" placeholder="Contact number during leave">
                        </div>
                        <div class="form-group">
                            <label for="supportingDoc">Supporting Document</label>
                            <input type="file" id="supportingDoc" name="supporting_doc" class="form-control" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
                            <small class="form-text">Upload medical certificate or other supporting documents (Max: 5MB)</small>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<style>
    ...
    .stat-card.annual-leave::before { background: var(--redcode-green); }
    .stat-card.sick-leave::before { background: var(--redcode-orange); }
    .stat-card.personal-leave::before { background: var(--redcode-blue); }
    .stat-card.pending-requests::before { background: var(--redcode-primary); }
    ...
    .stat-card.annual-leave .stat-icon { background: var(--redcode-green); }
    .stat-card.sick-leave .stat-icon { background: var(--redcode-orange); }
    .stat-card.personal-leave .stat-icon { background: var(--redcode-blue); }
    .stat-card.pending-requests .stat-icon { background: var(--redcode-primary); }
    ...
    .action-btn.download:hover { background: #22C55E; color: white; }
    .action-btn.reapply:hover { background: #8B5CF6; color: white; }
...
<script>
    ...
    const leaveRequests = {
        'LEV-2025-001': {
            id: 'LEV-2025-001',
            type: 'annual',
            typeDisplay: 'Annual Leave',
            startDate: '2025-03-15',
            endDate: '2025-03-20',
            startDateDisplay: 'March 15, 2025',
            endDateDisplay: 'March 20, 2025',
            duration: 5,
            reason: 'Family vacation',
            status: 'pending',
            statusDisplay: 'Pending',
            appliedDate: '2025-03-01',
            appliedDateDisplay: 'March 1, 2025',
        ...
        'LEV-2025-002': {
            ...
            endDateDisplay: 'February 12, 2025',
            duration: 3,
            reason: 'Medical treatment',
            status: 'approved',
            statusDisplay: 'Approved',
            appliedDate: '2025-02-08',
            appliedDateDisplay: 'February 8, 2025',
            contactInfo: '+1 (555) 123-4567',
            approver: 'Sarah Johnson',
            approvedDate: '2025-02-09',
            approvedDateDisplay: 'February 9, 2025',
            comments: 'Approved for medical treatment'
        },
        'LEV-2025-003': {
            id: 'LEV-2025-003',
            type: 'personal',
            typeDisplay: 'Personal Leave',
            startDate: '2025-01-25',
            endDate: '2025-01-26',
            startDateDisplay: 'January 25, 2025',
            endDateDisplay: 'January 26, 2025',
            duration: 2,
            reason: 'Personal matters',
            status: 'rejected',
            statusDisplay: 'Rejected',
            appliedDate: '2025-01-20',
            appliedDateDisplay: 'January 20, 2025',
            contactInfo: '+1 (555) 123-4567',
            approver: 'Mike Davis',
            rejectedDate: '2025-01-22',
            rejectedDateDisplay: 'January 22, 2025',
    ...
    document.getElementById('editLeaveForm').addEventListener('submit', function(e) {
        ...
        // Update the request data (in a real app, this would be sent to the server)
        if (leaveRequests[requestId]) {
            leaveRequests[requestId].type = formData.get('leave_type');
            leaveRequests[requestId].typeDisplay = document.getElementById('editLeaveType').selectedOptions[0].text;
            leaveRequests[requestId].startDate = formData.get('start_date');
            leaveRequests[requestId].endDate = formData.get('end_date');
            leaveRequests[requestId].reason = formData.get('reason');
            leaveRequests[requestId].contactInfo = formData.get('contact_info');
            
            // Update display dates
            const startDate = new Date(formData.get('start_date'));
            const endDate = new Date(formData.get('end_date'));
            leaveRequests[requestId].startDateDisplay = startDate.toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
            });
            leaveRequests[requestId].endDateDisplay = endDate.toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
            });
            ...
            leaveRequests[requestId].duration = diffDays;
        }
        
        closeEditLeaveModal();
        showMessage(`Leave request ${requestId} updated successfully`, 'success');
        
        // Update the UI card (in a real app, you might refresh the data from server)
        updateLeaveCard(requestId);
    });

                    ...
                    <div class="task-list">
                        <div class="task-item">
                            ...
                            <div class="task-content">
                                <h4>Update Employee Database</h4>
                                <p>Review and update employee records</p>
                                <div class="task-meta">
                        ...
                        <div class="task-item">
                            ...
                            <div class="task-content">
                                ...
                                <p>Compile monthly performance data</p>
                                <div class="task-meta">
                        ...
                        <div class="task-item">
                            ...
                            <div class="task-content">
                                ...
                                <p>Prepare agenda for weekly team meeting</p>
                                <div class="task-meta">
                    ...
                    <div class="announcement-list">
                        <div class="announcement-item">
                            ...
                            <div class="announcement-content">
                                <h4>Holiday Party</h4>
                                <p>Annual company holiday party on December 20th</p>
                        ...
                        <div class="announcement-item">
                            ...
                            <div class="announcement-content">
                                ...
                                <p>Welcome Sarah Johnson to the development team</p>
                                <span class="announcement-time">2 weeks ago</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<style>
    ...
    .activity-list, .task-list, .announcement-list {
        display: flex;
        flex-direction: column;
        gap: 1rem;
    }

    .activity-item, .task-item, .announcement-item {
        display: flex;
    ...
    .activity-item:hover, .task-item:hover, .announcement-item:hover {
        background: var(--bg-secondary);
        border-color: var(--primary);
    }

    .activity-icon, .announcement-icon {
        width: 40px;
        height: 40px;
        border-radius: 50%;
        background: var(--gradient-primary);
    ...
    .activity-content, .task-content, .announcement-content {
        flex: 1;
    }

    .activity-content h4, .task-content h4, .announcement-content h4 {
        color: var(--text-primary);
        font-size: 0.9rem;
        font-weight: 600;
        margin-bottom: 0.25rem;
    ...
    .activity-content p, .task-content p, .announcement-content p {
        color: var(--text-secondary);
        font-size: 0.8rem;
        margin-bottom: 0.5rem;
    }

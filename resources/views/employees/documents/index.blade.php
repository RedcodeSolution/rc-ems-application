    ...
    <div class="documents-container">
        ...
        <div class="documents-content" style="margin-bottom: 3rem;">
            ...
            <div id="documentsGrid"
                ...
                @forelse($documents as $document)
                    ...
                    <div class="document-card card p-4 border rounded shadow-sm transition hover:shadow-lg"
                        data-category="{{ $document->category }}" data-type="{{ $ext }}">
                        ...
                        <div class="document-info">
                            ...
                            <div class="document-meta">
                                <span><i class="fas fa-calendar"></i>
                                    {{ \Carbon\Carbon::parse($document->created_at)->format('M d, Y') }}</span>
                        ...
                        <div class="document-actions">
                            ...
                            <form action="{{ route('employee.documents.share', $document->id) }}" method="POST"
            ...
            <div class="flex justify-between items-center mt-4">
                ...
                <div class="flex gap-1">
                    ...
                    <!-- Next Page -->
                    <a href="{{ $documents->nextPageUrl() ?? '#' }}" class="btn btn-secondary"
                        style="padding: 0.5rem 0.75rem;" @if ($documents->hasMorePages()) @else disabled @endif>
                    ...
                    <div class="document-card card p-4 border rounded">
                        ...
                        <div class="card-body">
                            ...
                            <div class="flex justify-between mb-4 items-center">
                                <span class="badge"
                                    style="background: {{ $catBg }}; color: {{ $catText }}; padding:0.25rem 0.75rem;border-radius:1rem;font-size:0.75rem;">
                                    {{ $document->category }}
                                </span>
                            </div>
                        ...
                        <div class="document-actions">
                            ...
                            <form action="{{ route('employee.documents.shareCompany', $document->document_id) }}"
        ...
        <div id="uploadModal" class="modal">
            <div class="modal-content">
                ...
                <form id="uploadDocumentForm" method="POST" action="{{ route('employee.documents.store') }}"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="file-upload-area" onclick="document.getElementById('document_file').click()">
                                <input type="file" id="document_file" name="files[]"
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="documentDescription" name="description" class="form-control" rows="3"
